...
const SubBlocks = ({
  ...
  return (
    <div
      ...
      className="absolute pointer-events-none left-0 top-0 h-full w-full"
      style={{ zIndex: 1000}}
    >
      <div
        id="subBlocksInner"
        className="relative pointer-events-none w-full h-full overflow-hidden flex items-center"
      >
